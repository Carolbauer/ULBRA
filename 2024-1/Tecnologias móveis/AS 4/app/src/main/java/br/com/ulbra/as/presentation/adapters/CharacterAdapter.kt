package br.com.ulbra.`as`.presentation.adapters
...
import br.com.ulbra.`as`.databinding.CharacterItemBinding
...
class CharacterAdapter : RecyclerView.Adapter<CharacterAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val bindingHolder: CharacterItemBinding):
